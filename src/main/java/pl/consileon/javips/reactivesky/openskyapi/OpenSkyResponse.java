...
/**
 * Wrapper for data returned from OpenSky API
 * 
 * @author bartek
 * 
 * Fields provided in elements of 'states' array:
 * 
...
public class OpenSkyResponse {
    ...
    public String toString() {
        return states.getClass() + ", time: " + time + " states: " + ( states != null ? states.size() : 0 );
    }
}